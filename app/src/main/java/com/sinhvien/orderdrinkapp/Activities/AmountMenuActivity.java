...
public class AmountMenuActivity extends AppCompatActivity {
    ...
    private boolean validateAmount() {
        ...
        if (val.isEmpty()) {
            ...
            // Kiểm tra giới hạn nhập không quá 100
            double amount = Double.parseDouble(val);
            if (amount > 100) {
                TXTL_amountmenu_SoLuong.setError("Số lượng không được vượt quá 100");
                // Hiển thị thông báo hoặc gợi ý yêu cầu nhập lại
                Toast.makeText(this, "Vui lòng nhập lại số lượng không quá 100", Toast.LENGTH_SHORT).show();
                return false;
            } else {
