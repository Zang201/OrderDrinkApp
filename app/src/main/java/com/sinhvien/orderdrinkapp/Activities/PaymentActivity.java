...
public class PaymentActivity extends AppCompatActivity implements View.OnClickListener, OnclickItem {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String manTBL_DONDAT_MANV = intent.getStringExtra("MANV");
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.btn_payment_ThanhToan:
                ...
                if (maQuyen == 3) { // Kiểm tra nếu mã quyền là 3
                    Toast.makeText(getApplicationContext(), "Bạn không có quyền thanh toán.\nHãy làm những món trên cho khách.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (ktraban && ktradondat && ktratongtien) {
                        ...
                        // Phan chuyen sang BillView
//                        Intent intent = new Intent(getApplicationContext(), BillView1.class);
//                        //                    intent.putExtra("madondat",madondat);
//                        intent.putExtra("ngay_dat", TXT_payment_NgayDat.getText().toString());
//                        intent.putExtra("ten_ban", TXT_payment_TenBan.getText().toString());
//                        intent.putExtra("tong_tien", String.valueOf(tongtien));
